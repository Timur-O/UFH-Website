...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <meta name="description" content="Error 400 - Bad Request - Ultifree Hosting" />
        <meta name="robots" content="noindex">

        <title>Bad Request - Ultifree Hosting</title>
    ...
    <?php include '../nav.php';?>
        ...
        <section class="content">
          <div class="container" id="error_container">
            ...
            <p>
              The website couldn't understand your request.
            </p>
