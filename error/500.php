...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <meta name="description" content="Error 500 - Internal Server Error - Ultifree Hosting" />
        <meta name="robots" content="noindex">

        <title>Internal Server Error - Ultifree Hosting</title>
    ...
    <?php include '../nav.php';?>
        ...
        <section class="content">
          <div class="container" id="error_container">
            ...
            <p>
              Something broke when you tried to load this page. If you are the website owner try checking your .htaccess as bad coding there usually causes this error.
            </p>
